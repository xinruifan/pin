...
public class ExpandTabView extends LinearLayout implements FilterTabView.OnClickListener {
    ...
    public void setNameList(ArrayList<String> nameList) {
        ...
        LayoutParams tabParams = new LayoutParams(0,ViewGroup.LayoutParams.MATCH_PARENT,1);
        LayoutParams lineParams = new LayoutParams(1, ViewGroup.LayoutParams.MATCH_PARENT);
        for (int i = 0; i < nameList.size(); i++) {
            ...
            if (i < nameList.size()-1 ) {
               View line = new View(getContext());
                line.setBackgroundColor(ContextCompat.getColor(getContext(),R.color.divider_color));
    ...
    public void setExpandView(View expandView) {
        ...
        //ViewGroup view_container = (ViewGroup) expandView.getParent();
